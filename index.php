...
<!--	Title
	=========================================================-->
<title>Nickelodeon Estate</title>
...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <!--	Banner Start   -->
        <div class="overlay-black w-100 slider-banner1 position-relative" style="background-image: url('images/banner/landcover.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
                        ...
                        <div class="tab-content mt-4" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home">
                                <div class="row">
                                    ...
                                    {
                                        $query=mysqli_query($con,"SELECT property.*, user.uname,user.utype,user.uimage FROM `property`,`user` WHERE property.uid=user.uid and property.status = 'available'  ORDER BY date DESC LIMIT 9");
                                    }
                                    else{
                                        $query=mysqli_query($con,"SELECT property.*, user.uname,user.utype,user.uimage FROM `property`,`user` WHERE property.uid=user.uid and property.status = 'available' and property.uid != {$_SESSION['uid']} ORDER BY date DESC LIMIT 9");
                                    }
                                        ...
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            ...
                                            <div class="featured-thumb-data shadow-one">
                                                ...
                                                <div class="bg-gray quantity px-4 pt-4">
                                                    <ul>
                                                        <li><span><b><?php echo strtoupper($row['stype'])?></b></span></li>
		...
		<!--	Recent Properties  -->
        <div class="col-md-12">
                        <h2 class="text-secondary double-down-line text-center mb-4">For sale/For rents Location</h2>
                    </div>
...
?>
        ...
        <!--	Why Choose Us -->
        <div class="full-row living bg-one overlay-secondary-half" style="background-image: url('images/01.jpg'); top:20px; background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container">
                <div class="row">
