...
if(isset($_POST['add']))
{
	...
	$sql="INSERT INTO property (title,pcontent,type,stype,size,price,location,city,state,feature,pimage,pimage1,pimage2,pimage3,pimage4,uid,status,isFeatured)
	VALUES('$title','$content','$ptype','$stype','$asize','$price',
	'$loc','$city','$state','$feature','$aimage','$aimage1','$aimage2','$aimage3','$aimage4','$uid','$status','$isFeatured')";
