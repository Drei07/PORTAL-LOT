...
<head>
        ...
        <title>nickelodeon - Dashboard</title>
						...
						<div class="col-xl-3 col-sm-6 col-12">
							<div class="card">
								<div class="card-body">
									...
									<h3><?php $sql = "SELECT * FROM property where status = 'available' or status = 'sold out' ";
										$query = $con->query($sql);
                						echo "$query->num_rows";?></h3>
						...
						<div class="col-xl-3 col-sm-6 col-12">
							<div class="card">
								...
								<div class="dash-widget-header">
									...
									<h3><?php $sql = "SELECT * FROM property where status = 'Pending'";
										$query = $con->query($sql);
                						echo "$query->num_rows";?></h3>
										
										<h6 class="text-muted">Pending Properties</h6>
										<div class="progress progress-sm">
											<div class="progress-bar bg-info w-50"></div>
										</div>
									</div>
