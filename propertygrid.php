                        ...
                        <div class="row">
							...
							if(isset($_REQUEST['filter']))
							{
                                ...
                                if(isset($_SESSION['uid']) == '')
                                {
                                    ...
                                    $sql="SELECT property.*, user.uname FROM `property`,`user` WHERE property.uid=user.uid and type='{$type}' and stype='{$stype}' and city='{$city}' and property.uid != {$_SESSION['uid']}";
                                }
                    ...
                    <div class="col-lg-4">
						...
						<form class="d-inline-block w-100" action="calc.php" method="post">
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                ...
                                <input type="number" class="form-control" name="amount" placeholder="Property Price">
                            </div>
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                ...
                                <input type="number" class="form-control" name="month" placeholder="Duration Year">
                            </div>
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                ...
                                <input type="number" class="form-control" name="interest" placeholder="Interest Rate">
                            </div>
