...
?>  
  <div class="header">
                ...
                <div class="header-left">
					...
					<img class="nav-logo" src="../images/logo/logo_estate.png" style="height:100px;" alt="">
					</a>
                </div>
				<!-- /Logo -->
						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li><a href="userlist_seller.php"> Seller </a></li>
									<li><a href="userlist_agent.php"> Agents </a></li>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li><a href="pending.php"> Pending Property </a></li>
