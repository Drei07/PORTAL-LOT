...
<div id="page-wrapper">
    <div class="row"> 
                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">123 Pinagpala, Lubao</span> <br>
										<span class="text-white">123 Pinagpala, Lubao</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-white">+63 999-9999-999</span>
										<span class="text-white">+63 999-9999-999 </span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5> 
										<span class="d-table text-white">sample@gmail.com</span>
										<span class="text-white">sample@gmail.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
        ...
        <!--	Map -->
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d123382.50785307349!2d120.48571093201186!3d14.897856113635704!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33965eea12cf976f%3A0x92afee12a1d47006!2sLubao%2C%20Pampanga!5e0!3m2!1sen!2sph!4v1662514604036!5m2!1sen!2sph" width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
