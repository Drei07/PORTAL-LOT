...
if(isset($_REQUEST['reg']))
{
	...
	else
	{
		...
		if(!empty($name) && !empty($email) && !empty($phone) && !empty($pass) && !empty($uimage))
		{
			...
			$sql="INSERT INTO user (uname,uemail,uphone,upass,utype,uimage,seller_id) VALUES ('$name','$email','$phone','$pass','$utype','$uimage','$seller_id')";
			$result=mysqli_query($con, $sql);
			move_uploaded_file($temp_name1,"admin/user/$uimage");
			   if($result){
				   $msg = "<p class='alert alert-success'>Register Successfully for your Agent</p> ";
			   }
			   else{
                	...
                	<div class="loginbox">
                        <div class="login-right">
							<div class="login-right-wrap">
								<h1>Create Accout</h1>
								<p class="account-subtitle">For your Agent's</p>
								...
								<form method="post" enctype="multipart/form-data">
									...
									<button class="btn btn-success" name="reg" value="Register" type="submit">Create</button>
