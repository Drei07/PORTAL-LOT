    ...
    <div class="row"> 
        ...
        <div class="full-row bg-gray">
            <div class="container">
					...
					$sql_agnt = "SELECT * FROM user where uid = '$agent_number'";
					$result_agnt = $conn->query($sql_agnt);
					
					if ($result_agnt->num_rows > 0) {
					  // output data of each row
					  while($row_agnt = $result_agnt->fetch_assoc()) {
					...
					echo  $row_agnt["uname"];
                                ...
                                <?php if ($row['status'] == 'Pending' or $row['status'] == 'Decline')
                                {
                                ?>
                                <td><a class="btn btn-info" style="background-color:gray;border-color:gray;color:white;"  >Update</a></td>
                                    <?php
                                }else{
                                    ?>
